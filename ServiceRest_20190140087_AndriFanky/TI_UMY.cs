...
namespace ServiceRest_20190140087_AndriFanky
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-ND6HMKD;Initial Catalog=TI_UMY;Persist Security Info=True;User ID=sa;Password=s4.SQLSERVER");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-ND6HMKD;Initial Catalog=TI_UMY;Persist Security Info=True;User ID=sa;Password=s4.SQLSERVER");
        ...
        public Mahasiswa GetMahassiwaByNIM(string nim)
        {
            Mahasiswa mhs = new Mahasiswa();
