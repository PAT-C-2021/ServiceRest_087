...
namespace ServiceRest_20190140087_AndriFanky
{
    ...
    public interface ITI_UMY
    {
        ...
        Mahasiswa GetMahassiwaByNIM(string nim);
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_20190140087_AndriFanky.ContractType".
    [DataContract]
